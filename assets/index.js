...
var _ashishnegi$sanskell$Api$encodeJobPostBody = function (x) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'jobUrl',
				_1: _elm_lang$core$Json_Encode$string(x.jobUrl)
			}
			]));
};
...
var _ashishnegi$sanskell$Api$postJob = function (body) {
	var request = {
		...
		url: A2(_elm_lang$core$Basics_ops['++'], '/', 'job'),
		body: _evancz$elm_http$Http$string(
			A2(
				_elm_lang$core$Json_Encode$encode,
				0,
				_ashishnegi$sanskell$Api$encodeJobPostBody(body)))
	};
	return A2(
		_evancz$elm_http$Http$fromJson,
...
var _ashishnegi$sanskell$Api$Message = function (a) {
	return {message: a};
};
var _ashishnegi$sanskell$Api$decodeMessage = A2(
	_elm_community$elm_json_extra$Json_Decode_Extra_ops['|:'],
	_elm_lang$core$Json_Decode$succeed(_ashishnegi$sanskell$Api$Message),
...
var _ashishnegi$sanskell$Api$getJobById = function (id) {
	var request = {
		verb: 'GET',
		headers: _elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		_evancz$elm_http$Http$fromJson,
		_ashishnegi$sanskell$Api$decodeJobResult,
		A2(_evancz$elm_http$Http$send, _evancz$elm_http$Http$defaultSettings, request));
};
var _ashishnegi$sanskell$Api$Failed = {ctor: 'Failed'};
var _ashishnegi$sanskell$Api$Finished = {ctor: 'Finished'};
var _ashishnegi$sanskell$Api$Pending = {ctor: 'Pending'};
var _ashishnegi$sanskell$Api$decodeJobState = A2(
	_elm_lang$core$Json_Decode$andThen,
	...
	function (v) {
		...
		switch (_p0) {
			case 'Pending':
				return _elm_lang$core$Json_Decode$succeed(_ashishnegi$sanskell$Api$Pending);
			case 'Finished':
				return _elm_lang$core$Json_Decode$succeed(_ashishnegi$sanskell$Api$Finished);
			case 'Failed':
				return _elm_lang$core$Json_Decode$succeed(_ashishnegi$sanskell$Api$Failed);
			default:
				return _elm_lang$core$Json_Decode$fail('Unknown jobstate');
		}
	});
var _ashishnegi$sanskell$Api$decodeJobStatus = A2(
	_elm_community$elm_json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$elm_json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			_elm_community$elm_json_extra$Json_Decode_Extra_ops['|:'],
			_elm_lang$core$Json_Decode$succeed(_ashishnegi$sanskell$Api$JobStatus),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'statusJobId', _ashishnegi$sanskell$Api$decodeJobId)),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'jobResult', _ashishnegi$sanskell$Api$decodeMessage)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'jobState', _ashishnegi$sanskell$Api$decodeJobState));
var _ashishnegi$sanskell$Api$getJobStatusById = function (id) {
	var request = {
		verb: 'GET',
		headers: _elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		_evancz$elm_http$Http$fromJson,
		_ashishnegi$sanskell$Api$decodeJobStatus,
		A2(_evancz$elm_http$Http$send, _evancz$elm_http$Http$defaultSettings, request));
};
	...
	switch (_p5.ctor) {
		...
		case 'TextMessage':
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('status-msg')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
		...
		case 'ErrorMessage':
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('status-msg error-msg')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(_p5._0)
...
var _ashishnegi$sanskell$Main$svgDimension = function (d) {
	...
	return A2(
		...
		_elm_lang$core$Basics$round(
			_elm_lang$core$Basics$toFloat(dsize) / 1.5));
};
...
var _ashishnegi$sanskell$Main$wordSpiralPositions = F2(
	function (jobResult, _p11) {
		var _p12 = _p11;
		var _p13 = _p12.acceleration;
		var accR = _p13._0;
		var accTheta = _p13._1;
		var _p14 = _p12.deltas;
		var deltaR = _p14._0;
		var deltaTheta = _p14._1;
		var _p15 = _p12.initial;
		var initialR = _p15._0;
		var initialTheta = _p15._1;
		var positions = A2(
			_elm_lang$core$List$map,
			function (_p16) {
				var _p17 = _p16;
				...
				return {
					ctor: '_Tuple2',
					_0: _p18 * _elm_lang$core$Basics$cos(_p19),
					_1: _p18 * _elm_lang$core$Basics$sin(_p19)
				};
			},
			A3(
				...
				F2(
					function (_p21, _p20) {
						var _p22 = _p20;
						var newTheta = _p22._1 + (deltaTheta * (1 + accTheta));
						var newR = _p22._0 + (deltaR * (1 + accR));
		...
		var maxX = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			_elm_lang$core$List$maximum(allXs));
		var minX = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
		...
		var maxY = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			_elm_lang$core$List$maximum(allYs));
		var minY = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
		...
		return A2(
			_ashishnegi$sanskell$Main$makeWordCloud,
			jobResult,
			A2(
				_elm_lang$core$List$map,
				function (_p27) {
					...
					return A2(
						...
						_elm_lang$core$Basics$round(_p28._0),
						_elm_lang$core$Basics$round(_p28._1));
				},
				A2(
					_elm_lang$core$List$map,
					function (_p29) {
						var _p30 = _p29;
						return {ctor: '_Tuple2', _0: _p30._0 + (width / 2), _1: _p30._1 + (height / 2)};
					},
					positions)));
	});
var _ashishnegi$sanskell$Main$Flags = function (a) {
	return {jobId: a};
};
var _ashishnegi$sanskell$Main$URLMessage = F2(
	function (a, b) {
		return {ctor: 'URLMessage', _0: a, _1: b};
	});
var _ashishnegi$sanskell$Main$ErrorMessage = function (a) {
	return {ctor: 'ErrorMessage', _0: a};
};
var _ashishnegi$sanskell$Main$errorMsg = F2(
	function (error, defaultMsg) {
		var _p31 = error;
		if (_p31.ctor === 'BadResponse') {
...
var _ashishnegi$sanskell$Main$TextMessage = function (a) {
...
var _ashishnegi$sanskell$Main$ChangeAccelerationR = function (a) {
	return {ctor: 'ChangeAccelerationR', _0: a};
};
var _ashishnegi$sanskell$Main$ChangeDeltaTheta = function (a) {
	return {ctor: 'ChangeDeltaTheta', _0: a};
};
var _ashishnegi$sanskell$Main$ChangeDeltaR = function (a) {
	return {ctor: 'ChangeDeltaR', _0: a};
};
var _ashishnegi$sanskell$Main$ChangeInitialTheta = function (a) {
	return {ctor: 'ChangeInitialTheta', _0: a};
};
var _ashishnegi$sanskell$Main$ChangeInitialR = function (a) {
	return {ctor: 'ChangeInitialR', _0: a};
};
var _ashishnegi$sanskell$Main$spiralButtons = function (model) {
	var _p32 = model.spiralParams.acceleration;
	var ddr = _p32._0;
	var ddt = _p32._1;
	var _p33 = model.spiralParams.deltas;
	var dr = _p33._0;
	var dt = _p33._1;
	var _p34 = model.spiralParams.initial;
	var r = _p34._0;
	var t = _p34._1;
	return _elm_lang$core$Native_List.fromArray(
		[
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Events$onInput(_ashishnegi$sanskell$Main$ChangeInitialR),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('θ : '),
							A2(
							_elm_lang$html$Html$input,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Events$onInput(_ashishnegi$sanskell$Main$ChangeInitialTheta),
									_elm_lang$html$Html_Attributes$placeholder(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Δr : '),
							A2(
							_elm_lang$html$Html$input,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Events$onInput(_ashishnegi$sanskell$Main$ChangeDeltaR),
									_elm_lang$html$Html_Attributes$placeholder(
									_elm_lang$core$Basics$toString(dr)),
									_elm_lang$html$Html_Attributes$value(
									_elm_lang$core$Basics$toString(dr))
								]),
							_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Δθ : '),
							A2(
							_elm_lang$html$Html$input,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Events$onInput(_ashishnegi$sanskell$Main$ChangeDeltaTheta),
									_elm_lang$html$Html_Attributes$placeholder(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('ΔΔr : '),
							A2(
							_elm_lang$html$Html$input,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Events$onInput(_ashishnegi$sanskell$Main$ChangeAccelerationR),
									_elm_lang$html$Html_Attributes$placeholder(
									_elm_lang$core$Basics$toString(ddr)),
									_elm_lang$html$Html_Attributes$value(
									_elm_lang$core$Basics$toString(ddr))
								]),
							_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('ΔΔθ : '),
							A2(
							_elm_lang$html$Html$input,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Events$onInput(_ashishnegi$sanskell$Main$ChangeAccelerationTheta),
									_elm_lang$html$Html_Attributes$placeholder(
									_elm_lang$core$Basics$toString(ddt)),
									_elm_lang$html$Html_Attributes$value(
									_elm_lang$core$Basics$toString(ddt))
								]),
							_elm_lang$core$Native_List.fromArray(
...
var _ashishnegi$sanskell$Main$CheckJobStatus = {ctor: 'CheckJobStatus'};
var _ashishnegi$sanskell$Main$timeSubs = function (model) {
...
var _ashishnegi$sanskell$Main$JobResultSuccess = function (a) {
	return {ctor: 'JobResultSuccess', _0: a};
};
var _ashishnegi$sanskell$Main$StatusJobFailed = function (a) {
	return {ctor: 'StatusJobFailed', _0: a};
};
var _ashishnegi$sanskell$Main$StatusJobSuccess = function (a) {
	...
	return {
		...
		_0: A5(
			...
			A3(
				...
				{ctor: '_Tuple2', _0: 1.0, _1: 10.0},
				{ctor: '_Tuple2', _0: -1.0e-2, _1: -1.0e-2})),
		_1: _ashishnegi$sanskell$Main$cmdFromFlags(flags)
	};
};
var _ashishnegi$sanskell$Main$PostJobFailed = function (a) {
	return {ctor: 'PostJobFailed', _0: a};
};
var _ashishnegi$sanskell$Main$PostJobSuccess = function (a) {
	return {ctor: 'PostJobSuccess', _0: a};
};
		...
		switch (_p36.ctor) {
			...
			case 'PostJob':
				return {
					...
					_1: A3(
						_elm_lang$core$Task$perform,
						_ashishnegi$sanskell$Main$PostJobFailed,
						_ashishnegi$sanskell$Main$PostJobSuccess,
						_ashishnegi$sanskell$Api$postJob(
							_ashishnegi$sanskell$Api$JobPostBody(model.websiteUrl)))
				};
			case 'PostJobSuccess':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							statusMessage: _ashishnegi$sanskell$Main$TextMessage('Job successfully received.. It will take some time to process it.')
						}),
					_1: A3(
						_elm_lang$core$Task$perform,
						_ashishnegi$sanskell$Main$StatusJobFailed,
						_ashishnegi$sanskell$Main$StatusJobSuccess,
						_ashishnegi$sanskell$Api$getJobStatusById(_p36._0))
				};
			case 'PostJobFailed':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							statusMessage: A2(_ashishnegi$sanskell$Main$errorMsg, _p36._0, 'Failed to post job. Please try after some time.')
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'StatusJobSuccess':
				var _p39 = _p36._0;
				var _p37 = function () {
					var _p38 = _p39.jobState;
					switch (_p38.ctor) {
						case 'Pending':
							return {
								ctor: '_Tuple3',
								_0: A2(_ashishnegi$sanskell$Main$URLMessage, 'Still working on your job: ', _p39.jobResult.message),
								_1: _elm_lang$core$Platform_Cmd$none,
								_2: true
							};
						case 'Finished':
							return {
								ctor: '_Tuple3',
								_0: A2(_ashishnegi$sanskell$Main$URLMessage, 'You can view the word cloud at: ', _p39.jobResult.message),
								_1: A3(
									_elm_lang$core$Task$perform,
									_ashishnegi$sanskell$Main$JobResultFailed,
									_ashishnegi$sanskell$Main$JobResultSuccess,
									_ashishnegi$sanskell$Api$getJobById(_p39.statusJobId)),
								_2: false
							};
						default:
							return {
								ctor: '_Tuple3',
								_0: _ashishnegi$sanskell$Main$ErrorMessage(_p39.jobResult.message),
								_1: _elm_lang$core$Platform_Cmd$none,
								_2: false
							};
					}
				...
				var cmd = _p37._1;
				var pending = _p37._2;
				var pendingRequests = pending ? A2(_elm_lang$core$Set$insert, _p39.statusJobId, model.pendingRequests) : A2(_elm_lang$core$Set$remove, _p39.statusJobId, model.pendingRequests);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{statusMessage: msg, pendingRequests: pendingRequests}),
					_1: cmd
				};
			case 'StatusJobFailed':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							statusMessage: A2(_ashishnegi$sanskell$Main$errorMsg, _p36._0, 'Failed to get job status. Please try again.')
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'JobResultSuccess':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							wordCounts: A3(_elm_lang$core$Dict$insert, _p40.resultJobId, _p40, model.wordCounts)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'JobResultFailed':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							statusMessage: A2(_ashishnegi$sanskell$Main$errorMsg, _p36._0, 'Failed to get data. Please try again.')
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'CheckJobStatus':
			...
			case 'ChangeInitialR':
				var _p41 = _elm_lang$core$String$toFloat(_p36._0);
				if (_p41.ctor === 'Ok') {
					var mSpiralParams = model.spiralParams;
					var _p42 = model.spiralParams.initial;
					var x = _p42._0;
					var y = _p42._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								spiralParams: _elm_lang$core$Native_Utils.update(
									mSpiralParams,
									{
										initial: {ctor: '_Tuple2', _0: _p41._0, _1: y}
									})
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'ChangeInitialTheta':
				var _p43 = _elm_lang$core$String$toFloat(_p36._0);
				if (_p43.ctor === 'Ok') {
					var mSpiralParams = model.spiralParams;
					var _p44 = model.spiralParams.initial;
					var x = _p44._0;
					var y = _p44._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								spiralParams: _elm_lang$core$Native_Utils.update(
									mSpiralParams,
									{
										initial: {ctor: '_Tuple2', _0: x, _1: _p43._0}
									})
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'ChangeDeltaR':
				var _p45 = _elm_lang$core$String$toFloat(_p36._0);
				if (_p45.ctor === 'Ok') {
					var mSpiralParams = model.spiralParams;
					var _p46 = model.spiralParams.deltas;
					var x = _p46._0;
					var y = _p46._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								spiralParams: _elm_lang$core$Native_Utils.update(
									mSpiralParams,
									{
										deltas: {ctor: '_Tuple2', _0: _p45._0, _1: y}
									})
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'ChangeDeltaTheta':
				var _p47 = _elm_lang$core$String$toFloat(_p36._0);
				if (_p47.ctor === 'Ok') {
					var mSpiralParams = model.spiralParams;
					var _p48 = model.spiralParams.deltas;
					var x = _p48._0;
					var y = _p48._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								spiralParams: _elm_lang$core$Native_Utils.update(
									mSpiralParams,
									{
										deltas: {ctor: '_Tuple2', _0: x, _1: _p47._0}
									})
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'ChangeAccelerationR':
				var _p49 = _elm_lang$core$String$toFloat(_p36._0);
				if (_p49.ctor === 'Ok') {
					var mSpiralParams = model.spiralParams;
					var _p50 = model.spiralParams.acceleration;
					var x = _p50._0;
					var y = _p50._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								spiralParams: _elm_lang$core$Native_Utils.update(
									mSpiralParams,
									{
										acceleration: {ctor: '_Tuple2', _0: _p49._0, _1: y}
									})
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			default:
				var _p51 = _elm_lang$core$String$toFloat(_p36._0);
				if (_p51.ctor === 'Ok') {
					var mSpiralParams = model.spiralParams;
					var _p52 = model.spiralParams.acceleration;
					var x = _p52._0;
					var y = _p52._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								spiralParams: _elm_lang$core$Native_Utils.update(
									mSpiralParams,
									{
										acceleration: {ctor: '_Tuple2', _0: x, _1: _p51._0}
									})
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
...
var _ashishnegi$sanskell$Main$WebsiteInput = function (a) {
	return {ctor: 'WebsiteInput', _0: a};
};
var _ashishnegi$sanskell$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Events$onInput(_ashishnegi$sanskell$Main$WebsiteInput),
										_elm_lang$html$Html_Attributes$placeholder('any sanskrit website name')
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							])),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('send-job-btn'),
								_elm_lang$html$Html_Events$onClick(_ashishnegi$sanskell$Main$PostJob)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Make word cloud')
							]))
					]),
					_elm_lang$core$Native_List.fromArray(
					[
...
var _ashishnegi$sanskell$Main$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{init: _ashishnegi$sanskell$Main$init, view: _ashishnegi$sanskell$Main$view, update: _ashishnegi$sanskell$Main$update, subscriptions: _ashishnegi$sanskell$Main$subscriptions}),
	flags: A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _ashishnegi$sanskell$Main$main === 'undefined' ? null : _ashishnegi$sanskell$Main$main);
