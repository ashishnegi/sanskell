...
var _ashishnegi$sanskell$Main$someWordsCount = _elm_lang$core$Dict$fromList(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'ashish', _1: 30},
			{ctor: '_Tuple2', _0: 'negi', _1: 14}
		]));
var _ashishnegi$sanskell$Main$Model = F4(
	function (a, b, c, d) {
		return {websiteUrl: a, statusMessage: b, wordCounts: c, pendingRequests: d};
	});
...
var _ashishnegi$sanskell$Main$RandomWordCloudPositions = F2(
	function (a, b) {
		return {ctor: 'RandomWordCloudPositions', _0: a, _1: b};
	});
var _ashishnegi$sanskell$Main$randomWordPositionsCmd = F2(
	function (jobResult, dimension) {
		return A2(
			_elm_lang$core$Random$generate,
			_ashishnegi$sanskell$Main$RandomWordCloudPositions(jobResult),
			A2(
				...
				A3(
					...
					A2(_elm_lang$core$Random$int, 20, dimension.width - 60),
					A2(_elm_lang$core$Random$int, 20, dimension.height - 20))));
	});
...
var _ashishnegi$sanskell$Main$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: A4(_ashishnegi$sanskell$Main$Model, '', _ashishnegi$sanskell$Main$NoStatus, _elm_lang$core$Dict$empty, _elm_lang$core$Set$empty),
